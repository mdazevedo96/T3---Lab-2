...
/*RECEBE LISTA PROFESSOR E COD DO PROF QUE SE DESEJA BUSCAR*/
Professor* busca_prof(Professor* pr, char* cod);

/*RECEBE LISTA PROFESSOR E COD DO PROF Q SE DESEJA CADASTRAR, RETORNA TRUE SE JA EXISTIR, VICE-VERSA*/
