...
/*RECEBE LISTA PROJETO E CODIGO DO PROJETO QUE SE DESEJA BUSCAR*/
Projeto* projeto_busca(Projeto* p, char* cod);

/*RECEBE LISTA PROJETO E CODIGO DO PROJETO Q SE DESEJA CADASTRAR, RETORNA TRUE SE JA EXISTIR, VICE-VERSA*/
